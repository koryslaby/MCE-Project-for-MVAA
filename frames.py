...
class Frame:
    ...
    def __init__(self, x1, y1, width,height, leftPadding=6, bottomPadding=6,
        ...
        self.id = id
        self._debug = _debug
        self.frame_start_end_pos = []#added for CourseComparisonPDFgen.py
        ...
        self._geom()
        self._reset()
        #adding code to find frame start pos
        ...
        try:
            ...
            if y < p-_FUZZ:
                ...
                if fbg and fbg[-1].active:
                    ...
                    if bgm=='frame':
                        fbg.pop()
                self.frame_start_end_pos.append((self._x+self._leftExtraIndent, y))
